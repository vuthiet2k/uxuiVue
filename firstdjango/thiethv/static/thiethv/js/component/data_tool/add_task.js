const addTaskIcon = {
    ...
    <div class="ms-3 position-relative"
        ...
        <div class="position-absolute" style="background-color: #fff; width: 250px; z-index: 3;
        ...
        <div :class="{'d-none': !view}" style="position: fixed; inset: 0; z-index: 2" @mousedown="handleClickView"></div>
    </div>`,
    data: function () {
        return {
            view: false,
